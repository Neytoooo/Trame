        ...
        <>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-white/10 bg-gray-900/95 shadow-2xl backdrop-blur-xl animate-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between border-b border-white/10 p-6">
                            <h2 className="text-xl font-semibold text-white">Démarrer un chantier</h2>
                        ...
                        <form action={handleSubmit} className="p-6 space-y-5">
                            ...
                            {/* Nom du chantier */}
                            <div>
                                <label className="text-sm font-medium text-gray-400">Nom du projet</label>
                                <input name="name" required placeholder="ex: Rénovation SDB - Mr Dupont"
                                    className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white focus:border-blue-500 focus:outline-none" />
                            </div>
                            ...
                            <div>
                                ...
                                <select name="client_id" required className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white focus:border-blue-500 focus:outline-none [&>option]:bg-gray-900">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-sm font-medium text-gray-400">État</label>
                                    <select name="status" className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white focus:border-blue-500 focus:outline-none [&>option]:bg-gray-900">
                            ...
                            <div>
                                ...
                                <input name="date_debut" type="date"
                                    className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white focus:border-blue-500 focus:outline-none [color-scheme:dark]" />
                            </div>
